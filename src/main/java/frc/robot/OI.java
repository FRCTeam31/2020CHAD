...
import frc.robot.commands.Intake.intakeHighMotorPressed;
import frc.robot.commands.Intake.intakeHighMotorReleased;
...
import frc.robot.commands.Output.outputHighMotorPressed;
import frc.robot.commands.Output.outputHighMotorReleased;
...
public class OI {
  ...
  public static JoystickButton moveToTargetColorButton; // press hold b
    ...
    public static JoystickButton intakeHighButton; 
    public static JoystickButton outputHighButton; 
  ...
  public OI() {
    ...
    intakeButton = new JoystickButton(Stick2, 6); 
    outputButton = new JoystickButton(Stick2, 7);

    intakeHighButton = new JoystickButton(Stick2, 11);
    outputHighButton = new JoystickButton(Stick2, 10);
    ...
    intakeHighButton.whileHeld(new intakeHighMotorPressed());
    intakeHighButton.whenReleased(new intakeHighMotorReleased());
    outputHighButton.whileHeld(new outputHighMotorPressed());
    outputHighButton.whileHeld(new outputHighMotorReleased());
