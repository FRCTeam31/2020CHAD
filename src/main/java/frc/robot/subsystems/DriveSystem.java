...
public class DriveSystem extends Subsystem {
  ...
  public void Driving() {
    if (OI.Stick.getRawAxis(3) > 0 ) {
      RobotMap.differentialDrive.arcadeDrive(OI.Stick.getRawAxis(3), -OI.Stick.getRawAxis(0) * 0.8);
      System.out.println("*****************Z axis value is : " + OI.Stick.getRawAxis(0));
    }
    else if (OI.Stick.getRawAxis(2) > 0) {
      RobotMap.differentialDrive.arcadeDrive(-OI.Stick.getRawAxis(2), -OI.Stick.getRawAxis(0) * 0.8);
      System.out.println("*****************Z axis value is : " + OI.Stick.getRawAxis(0));
    }
    else {
      RobotMap.differentialDrive.arcadeDrive(0, -OI.Stick.getRawAxis(0) * 0.8);
      System.out.println("*****************Z axis value is : " + OI.Stick.getRawAxis(0));
